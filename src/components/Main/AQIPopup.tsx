...
export const AQIPopup = () => {
  ...
  return (
    <section className="fixed z-30 top-0 w-full md:top-1/2 md:left-1/2 md:transform md:-translate-x-1/2 md:-translate-y-1/2 bg-background text-on-surface max-w-3xl md:rounded-3xl ">
      ...
      <ul className="flex flex-col gap-3 p-6 overflow-y-auto scroll-px-40 ">
