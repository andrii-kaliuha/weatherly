  ...
  return (
    <>
      <header className="flex justify-center bg-[#111]">
        <nav className="flex items-center justify-between max-w-screen-xl w-full h-[90px] px-3 gap-3">
          <a href="">
          ...
          <div className="flex gap-3">
            <button className="md:hidden flex items-center justify-center bg-[#222] text-white h-[48px] w-[48px] rounded-full cursor-pointer border-transparent outline-transparent ">
