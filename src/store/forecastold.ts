...
//     this.date = new Date(data.current.dt * 1000).toLocaleDateString("en", {
//       day: "numeric",
//       month: "long",
//       weekday: "long",
//     });
...
//       time: rootStore.formatTime(hour.dt),
...
//         month: "long",
//       }),
//       weekday: new Date(day.dt * 1000).toLocaleString("en", {
//         weekday: "long",
//       }),
...
//     this.sunrise = rootStore.formatTime(data.daily[0].sunrise);
//     this.sunset = rootStore.formatTime(data.daily[0].sunset);
//     this.moonrise = rootStore.formatTime(data.daily[0].moonrise);
//     this.moonset = rootStore.formatTime(data.daily[0].moonset);
